...
# --- Execution Flow ---
msg = "THE WORLD’S OLDEST KNOWN RECIPE IS FOR BEER. DATING BACK NEARLY 4,000 YEARS, THE RECIPE WAS FOUND IN A SUMERIAN POEM CALLED THE 'HYMN TO NINKASI,' WHICH WAS ESSENTIALLY A TRIBUTE TO THE GODDESS OF BREWING. IT TURNS OUT THAT ANCIENT CIVILIZATIONS WERE JUST AS INTERESTED IN A COLD DRINK AS WE ARE TODAY!"
key = 7
